...
class TestCalculateDiscount(unittest.TestCase):
    ...
    def test_age_30(self):
        self.assertEqual(calculate_discount(30), 0.00)
    ...
    def test_age_51(self):
        self.assertEqual(calculate_discount(51), 0.10)

    def test_age_55(self):
        self.assertEqual(calculate_discount(55), 0.10)
    
    def test_age_64(self):
        self.assertEqual(calculate_discount(64), 0.10)

    # 65 <= age <= 89
    def test_age_65(self):
        self.assertEqual(calculate_discount(65), 0.15)

    def test_age_66(self):
        self.assertEqual(calculate_discount(66), 0.15)

    def test_age_70(self):
        self.assertEqual(calculate_discount(70), 0.15)

    def test_age_89(self):
        self.assertEqual(calculate_discount(89), 0.15)

    # age >= 90
    def test_age_90(self):
        self.assertEqual(calculate_discount(90), 1.00)

    def test_age_91(self):
        self.assertEqual(calculate_discount(91), 1.00)

    def test_age_95(self):
        self.assertEqual(calculate_discount(95), 1.00)
